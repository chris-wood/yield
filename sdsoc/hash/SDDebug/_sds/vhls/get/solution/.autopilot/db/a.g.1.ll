; ModuleID = 'C:/Users/sskalick/Xilinx/hash/hash/SDDebug/_sds/vhls/get/solution/.autopilot/db/a.g.1.bc'
...
define internal fastcc void @hash(i32 %key, i32* %h) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i32 %key}, i64 0, metadata !43), !dbg !44 ; [debug line = 27:20] [debug variable = key]
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !45), !dbg !46 ; [debug line = 27:36] [debug variable = h]
  store i32 %key, i32* %h, align 4, !dbg !47      ; [debug line = 28:2]
  ret void, !dbg !49                              ; [debug line = 29:1]
}
...
define i32 @get(i32* %data, i32 %key, i32* %val) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %data}, i64 0, metadata !56), !dbg !57 ; [debug line = 33:19] [debug variable = data]
  call void @llvm.dbg.value(metadata !{i32 %key}, i64 0, metadata !58), !dbg !59 ; [debug line = 33:34] [debug variable = key]
  call void @llvm.dbg.value(metadata !{i32* %val}, i64 0, metadata !60), !dbg !61 ; [debug line = 33:49] [debug variable = val]
  call void (...)* @_ssdm_op_SpecLatency(i32 1, i32 65535, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !62 ; [debug line = 34:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %data, i8* getelementptr inbounds ([6 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !62 ; [debug line = 34:1]
  call void @llvm.dbg.declare(metadata !{i32* %h}, metadata !64), !dbg !65 ; [debug line = 34:12] [debug variable = h]
  call fastcc void @hash(i32 %key, i32* %h), !dbg !66 ; [debug line = 35:2]
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !64), !dbg !67 ; [debug line = 36:2] [debug variable = h]
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !64), !dbg !67 ; [debug line = 36:2] [debug variable = h]
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !64), !dbg !67 ; [debug line = 36:2] [debug variable = h]
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !64), !dbg !67 ; [debug line = 36:2] [debug variable = h]
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !64), !dbg !67 ; [debug line = 36:2] [debug variable = h]
  ...
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !64), !dbg !67 ; [debug line = 36:2] [debug variable = h]
  call void @llvm.dbg.value(metadata !{i32* %h}, i64 0, metadata !64), !dbg !67 ; [debug line = 36:2] [debug variable = h]
  %h.load = load i32* %h, align 4, !dbg !67       ; [#uses=1 type=i32] [debug line = 36:2]
  %tmp = zext i32 %h.load to i64, !dbg !67        ; [#uses=1 type=i64] [debug line = 36:2]
  %data.addr = getelementptr inbounds i32* %data, i64 %tmp, !dbg !67 ; [#uses=1 type=i32*] [debug line = 36:2]
  %data.load = load i32* %data.addr, align 4, !dbg !67 ; [#uses=2 type=i32] [debug line = 36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %data.load) nounwind
  call fastcc void @assign_val(i32* %val, i32 %data.load), !dbg !67 ; [debug line = 36:2]
  ret i32 0, !dbg !68                             ; [debug line = 38:2]
}
...
!43 = metadata !{i32 786689, metadata !14, metadata !"key", metadata !6, i32 16777243, metadata !17, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!44 = metadata !{i32 27, i32 20, metadata !14, null}
!45 = metadata !{i32 786689, metadata !14, metadata !"h", metadata !6, i32 33554459, metadata !18, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!46 = metadata !{i32 27, i32 36, metadata !14, null}
!47 = metadata !{i32 28, i32 2, metadata !48, null}
!48 = metadata !{i32 786443, metadata !14, i32 27, i32 39, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!49 = metadata !{i32 29, i32 1, metadata !48, null}
...
!56 = metadata !{i32 786689, metadata !20, metadata !"data", metadata !6, i32 16777249, metadata !24, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!57 = metadata !{i32 33, i32 19, metadata !20, null}
!58 = metadata !{i32 786689, metadata !20, metadata !"key", metadata !6, i32 33554465, metadata !17, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!59 = metadata !{i32 33, i32 34, metadata !20, null}
!60 = metadata !{i32 786689, metadata !20, metadata !"val", metadata !6, i32 50331681, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!61 = metadata !{i32 33, i32 49, metadata !20, null}
!62 = metadata !{i32 34, i32 1, metadata !63, null}
!63 = metadata !{i32 786443, metadata !20, i32 33, i32 54, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!64 = metadata !{i32 786688, metadata !63, metadata !"h", metadata !6, i32 34, metadata !19, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!65 = metadata !{i32 34, i32 12, metadata !63, null}
!66 = metadata !{i32 35, i32 2, metadata !63, null}
!67 = metadata !{i32 36, i32 2, metadata !63, null}
!68 = metadata !{i32 38, i32 2, metadata !63, null}
