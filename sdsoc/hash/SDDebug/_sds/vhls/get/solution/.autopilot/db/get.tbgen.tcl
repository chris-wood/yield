set C_TypeInfoList {{ 
"get" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"data": [[],{ "pointer": "0"}] }, {"key": [[],"1"] }, {"val": [[], {"reference": "0"}] }],[],""], 
...
set C_modelArgList { 
	...
	{ data int 32 regular  }
	{ key int 32 regular  }
	{ val_r int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "data","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "data"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "val_r", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "val","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ val_r sc_out sc_lv 32 signal 3 } 
	{ val_r_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "val_r", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "val_r", "role": "default" }} , 
 	{ "name": "val_r_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "val_r", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	val_r { ap_vld {  { val_r out_data 1 32 }  { val_r_ap_vld out_vld 1 1 } } }
}
