set C_TypeInfoList {{ 
"set" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"data": [[],{ "pointer": "0"}] }, {"key": [[],"1"] }, {"val": [[],"0"] }],[],""], 
"1": [ "key_type", {"typedef": [[[], {"scalar": "unsigned int"}],""]}], 
"0": [ "val_type", {"typedef": [[[], {"scalar": "unsigned int"}],""]}]
}}
set moduleName set
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "data","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "data"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "val_r", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "val","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ key sc_in sc_lv 32 signal 2 } 
	{ val_r sc_in sc_lv 32 signal 3 } 
