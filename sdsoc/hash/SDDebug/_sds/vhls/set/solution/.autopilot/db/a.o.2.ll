...
define i32 @set(i32* %data, i32 %key, i32 %val) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %data}, i64 0, metadata !65), !dbg !66 ; [debug line = 42:19] [debug variable = data]
  call void @llvm.dbg.value(metadata !{i32 %key}, i64 0, metadata !67), !dbg !68 ; [debug line = 42:34] [debug variable = key]
  call void @llvm.dbg.value(metadata !{i32 %val}, i64 0, metadata !69), !dbg !70 ; [debug line = 42:48] [debug variable = val]
  call void (...)* @_ssdm_op_SpecLatency(i32 1, i32 65535, [1 x i8]* @.str) nounwind, !dbg !71 ; [debug line = 43:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %data, [6 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str, [7 x i8]* @.str2, [1 x i8]* @.str, [1 x i8]* @.str) nounwind, !dbg !71 ; [debug line = 43:1]
  call void @llvm.dbg.value(metadata !{i32 %key}, i64 0, metadata !73), !dbg !75 ; [debug line = 27:20@44:2] [debug variable = key]
  call void @llvm.dbg.value(metadata !{i32 %key}, i64 0, metadata !76), !dbg !77 ; [debug line = 27:36@44:2] [debug variable = h]
  call void @llvm.dbg.value(metadata !{i32 %key}, i64 0, metadata !78), !dbg !74 ; [debug line = 44:2] [debug variable = h]
  call fastcc void @assign_val(i32* %data, i32 %key, i32 %val) nounwind, !dbg !79 ; [debug line = 45:2]
  ret i32 0, !dbg !80                             ; [debug line = 47:2]
}
...
; [#uses=1]
define internal fastcc void @assign_val(i32* %dest, i32 %tmp, i32 %src) {
  %tmp.cast = zext i32 %tmp to i64                ; [#uses=2 type=i64]
  call void (...)* @_ssdm_SpecKeepAssert(i64 %tmp.cast), !hlsrange !81
  %dest.addr = getelementptr i32* %dest, i64 %tmp.cast ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_op_SpecInterface(i32* %dest, [6 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str, [7 x i8]* @.str2, [1 x i8]* @.str, [1 x i8]* @.str)
  call void @llvm.dbg.value(metadata !{i32* %dest}, i64 0, metadata !82), !dbg !83 ; [debug line = 23:27] [debug variable = dest]
  call void @llvm.dbg.value(metadata !{i32 %src}, i64 0, metadata !84), !dbg !85 ; [debug line = 23:42] [debug variable = src]
  store i32 %src, i32* %dest.addr, align 4, !dbg !86 ; [debug line = 24:2]
  ret void, !dbg !88                              ; [debug line = 25:1]
}
...
!58 = metadata !{metadata !"val", metadata !53, metadata !"unsigned int", i32 0, i32 31}
...
!65 = metadata !{i32 786689, metadata !25, metadata !"data", metadata !6, i32 16777258, metadata !24, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!66 = metadata !{i32 42, i32 19, metadata !25, null}
!67 = metadata !{i32 786689, metadata !25, metadata !"key", metadata !6, i32 33554474, metadata !17, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!68 = metadata !{i32 42, i32 34, metadata !25, null}
!69 = metadata !{i32 786689, metadata !25, metadata !"val", metadata !6, i32 50331690, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!70 = metadata !{i32 42, i32 48, metadata !25, null}
!71 = metadata !{i32 43, i32 1, metadata !72, null}
!72 = metadata !{i32 786443, metadata !25, i32 42, i32 53, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
...
!74 = metadata !{i32 44, i32 2, metadata !72, null}
...
!78 = metadata !{i32 786688, metadata !72, metadata !"h", metadata !6, i32 43, metadata !19, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!79 = metadata !{i32 45, i32 2, metadata !72, null}
!80 = metadata !{i32 47, i32 2, metadata !72, null}
!81 = metadata !{i32 -2147483648, i32 2147483647, i32 0, i32 -1} 
!82 = metadata !{i32 786689, metadata !5, metadata !"dest", metadata !6, i32 16777239, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!83 = metadata !{i32 23, i32 27, metadata !5, null}
!84 = metadata !{i32 786689, metadata !5, metadata !"src", metadata !6, i32 33554455, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!85 = metadata !{i32 23, i32 42, metadata !5, null}
!86 = metadata !{i32 24, i32 2, metadata !87, null}
!87 = metadata !{i32 786443, metadata !5, i32 23, i32 47, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!88 = metadata !{i32 25, i32 1, metadata !87, null}
